...
.SYNOPSIS
    This function creates a new Group Policy Object (GPO) and links it to the Domain Controllers OU. The policy disables TLS 1.0 and 1.1 on all domain controllers.

.PARAMETER GpoName
    The name of the new GPO to create.

.EXAMPLE
    Disable-DomainControllerTls1 -GpoName 'Domain Controllers Disable TlS 1.1 and 1.0'

    This example creates a new GPO named 'Domain Controllers Disable TlS 1.1 and 1.0' and links it to the Domain Controllers OU in Active Directory.

.DESCRIPTION
    When an Active Directory domain controller has a valid TLS certificate installed, TLS can be used for LDAP communcation (LDAPS). By default, domain controllers support TLS 1.0, 1.1, and 1.2. However, it is recommended to disable TLS 1.0 and 1.1 to improve security. This function creates a new Group Policy Object (GPO) in Active Directory and links it to the Domain Controllers OU. The policy disables TLS 1.0 and 1.1 on all domain controllers to improve security.

.LINK
    https://github.com/richardhicks/adcstools/blob/main/Functions/Disable-DomainControllerTls1.ps1
...
Function Disable-DomainControllerTls1 {
    ...
    Param (
        ...
        [string]$GpoName = 'Domain Controllers Disable TlS 1.1 and 1.0'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUbjFGkGDngN1r8M/ZXzIxkqUQ
# e36ggiDDMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# MRYEFNHosDm0+LSyy/I/aFOvOevfgk+uMA0GCSqGSIb3DQEBAQUABIIBgCh7SvvG
# 3jC7AY+SN9FMOwQyLrbIrL666whcqZ9dvIPViRI3VqEgR1+y4IFje9BzV9Cwkja0
# 4jA0EiGzGUwWcqCw6iZYYBHMOon1FY7NHmx7amwCQDDkyUTzVvExEy8B/elfAk3y
# SjdEpbLWfHLsp7GPGcWElN+j7BoDErCc5wrVl8SJ1Ik8WSaCTGmlKv/IexuceEaW
# 37yu0y5NCQ9E2aIuNVzy1Ljk3WA3rzrZ1ntfDdUT/6jzExYAnDvf3AVVoD2Od1zd
# /e/KpqPXGlQZySkGzZCICIuBpKeJnBbHoui+0ULb1ZaVhWqVqLaK9/ya1lIxKDTU
# J8eNrVLHqTllR1ZH8GyZJWr8/UhtJd6TlxoYuCqxQzDzIfXiNKqD0zApXakzOMnJ
# /mrzceL9JS70ObmZ36SSMFbn1upDpObPH17YoP2oCgZFO7lWYJ5++0Kheo76rS3e
# TWhLoVFQSDJQhM+albLhMWoBrAO2Nlm2OSrga1Z+wMiiXpnpQXfEt4PkpKGCAyAw
...
# CSqGSIb3DQEJBTEPFw0yNDAzMjAyMzA4MTFaMC8GCSqGSIb3DQEJBDEiBCDjx5FW
# U3wCoB9x6LeJxwn1kpUp+mp4bL+A51dcGjLruDANBgkqhkiG9w0BAQEFAASCAgBP
# MYmpk3Gt+0y3le2JjReLL5PViAA4k27dMji2RVyOnmMU6qTnXBF/Tr6TN2G/5eRM
# paHzIquakmn4wYdyb7CYcAcs0ECByr/9GdhSJZ1muzDzr0E7DU4tpZLbVm+IiZTa
# 6HsUCjbfZslW52pibqvy0yPeb3QrzyPHfIlxWWm1viczmoGLVL+We4t+5GSAJgNZ
# KbYaF7W46puhB75t485YJOXo1qZd6Z1FkObn89mpcOYfJC7sgcGfz7uLvXsqiwXG
# 6GT6KbdFQNUzI9zLtsZ1sv/faJ+XNuag8EFUY1mRXjwZyLLM6100IlqPlJ0MeHhO
# TILHiP/Rf136vcP2sVAPec/iPYOMd9vLfZgTJ9W9sRA+wTeNFyhq5/JTM3V94UG+
# ySCQ51Ey7Fc02yQJCtBLABvsWSwMaHGNCNg3WnakpHLe5d7U2GBQt1mPvUMSM1FE
# u7t6B964SJibqQ9E7yYJLvsZjomNYVxzLW7nGaXHqfm4ZzAGGeV5bLxMPmxXH+N8
# l/+Pd1Qalzh27jFP90OkWfsF4BFN9zKlUFyOglYJZ1yIcofRExxcu4b2smtoRQqy
# HTs+7Q7uJmLZWlITK6P/6d0Xc1Jza8VQYgknPYAM28A1ptFO1u0QUJhF0lXs6C+E
# dxYmsCRGFFRUcC0CFTxvubsOyIQJzJUiHvLmd1tDzA==
